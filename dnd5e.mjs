 ...
 * @enum {object}
 */
DND5E.spellClassList = {
  artificer: {
    label: "DND5E.ClassesArtificer"
  },
  bard: {
    label: "DND5E.ClassesBard"
  },
  cleric: {
    label: "DND5E.ClassesCleric"
  },
  druid: {
    label: "DND5E.ClassesDruid"
  },
  paladin: {
    label: "DND5E.ClassesPaladin"
  },
  ranger: {
    label: "DND5E.ClassesRanger"
  },
  sorcerer: {
    label: "DND5E.ClassesSorcerer"
  },
  warlock: {
    label: "DND5E.ClassesWarlock"
  },
  wizard: {
    label: "DND5E.ClassesWizard"
  },
};
preLocalize("spellClassList", {keys: ["label", "abbr"]});
  ...
  async getData(options) {
    ...
    switch ( item.type ) {
      ...
      case "spell":
        ...
        ///MAXPAT
        context.spellClassList = {...CONFIG.DND5E.spellClassList};
        break;
    }
 ...
 * @property {boolean} components.concentration  Does this spell require concentration? MAXPAT
...
class SpellData extends SystemDataModel.mixin(
  ...
  static defineSchema() {
    return this.mergeSchema(super.defineSchema(), {
      ...
      ///MAXPAT
      spellclasslist: new MappingField(new foundry.data.fields.BooleanField(), {
        required: true, label: "DND5E.SpellClassList",
        initialKeys: [...Object.keys(CONFIG.DND5E.spellClassList), ...Object.keys(CONFIG.DND5E.spellClassList)]
      }),
